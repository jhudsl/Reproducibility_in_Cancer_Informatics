...
4. Delete all the default text in this notebook but keep the header which looks like:
```
---
title: "R Notebook"
...
---
```
You can feel free to change the title from `R Notebook` to something that better suits what we are doing here.

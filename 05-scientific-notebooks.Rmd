...
To get the _Python project example files_, [click this link](https://raw.githubusercontent.com/Reproducibility_in_Cancer_Informatics/main/chapter-zips/python-heatmap-chapt-5.zip).

```{bash, include = FALSE}
mkdir -p chapter-zips
wget -O chapter-zips/python-heatmap-chapt-5.zip https://raw.githubusercontent.com/Reproducibility_in_Cancer_Informatics/main/chapter-zips/python-heatmap-chapt-5.zip
```
...
ls chapter-zips/python-heatmap-chapt-5
```
...
To get the _R project examples files_ [click this link](https://raw.githubusercontent.com/Reproducibility_in_Cancer_Informatics/main/chapter-zips/r-heatmap-chapt-5.zip).
Or you can use these commands in command line.

```{bash, include = FALSE}
mkdir -p chapter-zips
wget -O chapter-zips/r-heatmap-chapt-5.zip https://raw.githubusercontent.com/Reproducibility_in_Cancer_Informatics/main/chapter-zips/chapter-zips/r-heatmap-chapt-5.zip
```
...
```{bash, echo = FALSE, class.source = 'fold-show'}
ls chapter-zips/r-heatmap-chapt-5
```

...
2. Then, [following the instructions](https://jupyterlab.readthedocs.io/en/stable/getting_started/installation.html), Install JuptyerLab using this command in your [command line window](https://towardsdatascience.com/a-quick-guide-to-using-command-line-terminal-96815b97b955#:~:text=Opening%20Command%20Line.&text=There%20are%20varying%20ways%20of,and%20press%20the%20return%20key.): `conda install -c conda-forge jupyterlab`
3. If you installed juptyer lab successfully, you can run `jupyter lab` in your command line window and a window will open in your browser. (Note that if run this multiple times, you will need to close one of your JuptyerLab browser windows, or follow their documentation to set a password). 

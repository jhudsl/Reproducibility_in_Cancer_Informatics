...
## Tools to be discussed in this course

In this course, we will discuss the following tools for conducting your analyses reproducibly:
...
We have set up some files that may resemble a "typical" analysis. Throughout this course, we will incrementally transform these analysis files into a beautifully reproducible project by applying what we discuss in each chapter with hands-on exercises.

In our [follow up course](), you can further enhance the reproducibility of this project by learning and applying even more techniques. Here's a preview of what will be discussed in that course.

```{r, fig.alt="Title image: Reproducibility in Cancer Informatics", out.width = "100%", echo = FALSE}
leanbuild::include_slide("https://docs.google.com/presentation/d/1LMurysUhCjZb7DVF6KS9QmJ5NBjwWVjRn40MS9f2noE/edit#slide=id.gf7bed24491_0_0")
```

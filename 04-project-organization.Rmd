...
To get the _Python project example files_, copy and paste these commands below into your [command line](https://towardsdatascience.com/a-quick-guide-to-using-command-line-terminal-96815b97b955) and press Enter.
Or [click this link](https://raw.githubusercontent.com/jhudsl/Reproducibility-Examples/main/chapter-zips/r-heatmap-chapt-4.zip).
...
```{bash, echo = FALSE, message = FALSE, results = 'hide'}
...
To get the _R project examples files_ copy and paste these commands below into your [command line](https://towardsdatascience.com/a-quick-guide-to-using-command-line-terminal-96815b97b955) and press Enter.
Or [click this link](https://raw.githubusercontent.com/jhudsl/Reproducibility-Examples/main/chapter-zips/r-heatmap-chapt-4.zip).

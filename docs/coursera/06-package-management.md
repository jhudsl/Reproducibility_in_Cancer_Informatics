...
```
## --2021-10-27 16:22:43--  https://raw.githubusercontent.com/jhudsl/reproducible-python-example/main/environment.yml
...
##      0K ..                                                    100% 39.8M=0s
## 
## 2021-10-27 16:22:43 (39.8 MB/s) - ‘environment.yml.2’ saved [2657/2657]
```

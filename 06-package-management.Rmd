...
In your scientific notebook, add a chunk in the very end that looks like this: 
`````
```{r}
sessionInfo()
```
...
1. Download this [starter conda environment.yml file](https://raw.githubusercontent.com/civisanalytics/datascience-python/master/environment.yml) by clicking on the link. 

```{bash}
wget -O https://raw.githubusercontent.com/civisanalytics/datascience-python/master/environment.yml
```

3. [Open up your command line](https://towardsdatascience.com/a-quick-guide-to-using-command-line-terminal-96815b97b955) and install nb_conda_kernels using this command:
```
...
1. Install renv using: 

```{r, echo = FALSE}
install.packages("renv")
```

2. Get the _R project examples files_ [click this link](https://raw.githubusercontent.com/jhudsl/Reproducibility_in_Cancer_Informatics/main/chapter-zips/r-heatmap-chapt-5.zip) or continue using the files you were working on from the last chapter. 
...
5. Follow [these instructions to add your renv.lock file to the repository you created in the previous chapter](https://docs.github.com/en/repositories/working-with-files/managing-files/adding-a-file-to-a-repository#adding-a-file-to-a-repository-on-github). Later we will practice and discuss how to more fully utilize the features of GitHub. 

...
Not only does code review help boost the accuracy and reprodudcibility of the analysis, it also helps everyone involved in the process learn something new!

## Exercise: Send your code to someone else to run!

In the second part of this reproducibility course we will discuss how to conduct formal line-by-line code reviews, but for now, we will simply encourage you to have someone else look at your code and attempt to run it.  
...
9) Now you are ready to send your crafted message to your collaborator for review. 
